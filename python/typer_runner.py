...
def run(
    ...
    input_dir = get_folder_path("Please insert your image for editing folder name/location")
    output_dir = get_folder_path("Please insert your image edited output folder name/location")

    profile_name = get_input("Please insert your profile project name")
    api_key = get_input("Please insert your unique API Key")

    hdr_merge = get_boolean_choice("HDR merge")
    crop = get_boolean_choice("crop")
    straighten = get_boolean_choice("straighten")
    subject_mask = get_boolean_choice("subject mask")
    """
